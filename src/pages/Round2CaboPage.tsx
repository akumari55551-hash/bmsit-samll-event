    ...
    <div className="space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold text-slate-800">
              Round 2: Cabo Operations Console
            </h2>
            {data?.config.isFinalized ? (
              <Badge variant="success" size="sm" dot>
                Finalized &amp; Sealed
          ...
          <div className="flex flex-wrap items-center gap-2 mt-1 text-xs text-slate-500">
            <span>24 Qualified Teams from R1</span>
            <span>&middot;</span>
            <span>3 Cabo Games</span>
            <span>&middot;</span>
            <span>Top 12 advance to Round 3: The Black Market</span>
            <span>&middot;</span>
            <span className="inline-flex items-center gap-1 text-[11px] font-medium text-amber-800 bg-amber-50 px-2 py-0.5 rounded border border-amber-200">
              ...
              Scoring: Configurable Demo Defaults (Unconfirmed)
            </span>
          </div>
        </div>
      ...
      <div className="flex border-b border-slate-200 bg-white rounded-t-xl px-4 pt-2">
        ...
        >
          ...
          <span className="text-[10px] px-1.5 py-0.2 rounded bg-slate-100 text-slate-600 font-mono font-normal">
          ...
          {!data?.config.isFinalized && !data?.engine.canFinalize && data?.engine.blockReason && (
            <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-600 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span>
                  <strong>Qualification Standby:</strong> {data.engine.blockReason}
                </span>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-2.5 w-full md:w-auto">
              <div className="flex items-center gap-1.5 text-xs text-slate-500">
                ...
                >
                  ...
                  <option value="top12">Top 12 Advancing</option>
                  <option value="eliminated">Elimination Zone</option>
                  <option value="tieReview">Tie Review Needed</option>
              ...
              <div className="flex items-center gap-1.5 text-xs text-slate-500">
                ...
                >
                  ...
                  <option value="complete">All 3 Games Complete</option>
                  <option value="missing">Missing Games</option>
                  <option value="missingG1">Missing Game 1</option>
                  <option value="missingG2">Missing Game 2</option>
                  <option value="missingG3">Missing Game 3</option>
                </select>
              </div>
            </div>
          </div>
            ...
            <CardHeader className="flex flex-row items-center justify-between py-3 px-4 border-b border-slate-100">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-amber-700 bg-amber-50 px-2 py-0.5 rounded border border-amber-200">
                  Scoring: {data?.config.scoringDirection === 'higher_is_better' ? 'Higher Points Win' : 'Lower Points Win'} (Demo Default)
                </span>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-slate-200 bg-slate-50/75 text-[11px] font-semibold text-slate-600 uppercase tracking-wider">
                      <th
                        className="py-3 px-3 text-center w-14 cursor-pointer hover:text-blue-600 transition-colors"
                      ...
                      paginatedRecords.map((rec) => {
                        ...
                        return (
                          <React.Fragment key={rec.teamId}>
                            ...
                            >
                              ...
                              <td className="py-3 px-4">
                                ...
                                {rec.tieRequiresReview && (
                                  <span className="inline-flex items-center gap-1 text-[10px] text-amber-700 mt-1 font-medium">
                                    <AlertTriangle className="w-3 h-3 text-amber-600" />
                              ...
                              <td className="py-3 px-3 text-center">
                                {rec.game1Placement ? (
                                  <span className="font-mono text-xs font-semibold text-slate-700">
                                    #{rec.game1Placement} <span className="text-[11px] text-slate-400">({rec.game1Points} pts)</span>
                                  </span>
                                ) : (
                              ...
                              <td className="py-3 px-3 text-center">
                                {rec.game2Placement ? (
                                  <span className="font-mono text-xs font-semibold text-slate-700">
                                    #{rec.game2Placement} <span className="text-[11px] text-slate-400">({rec.game2Points} pts)</span>
                                  </span>
                                ) : (
                                  <span className="text-slate-300 font-mono">—</span>
                                )}
                              ...
                              <td className="py-3 px-3 text-center">
                                {rec.game3Placement ? (
                                  <span className="font-mono text-xs font-semibold text-slate-700">
                                    #{rec.game3Placement} <span className="text-[11px] text-slate-400">({rec.game3Points} pts)</span>
                                  </span>
                                ) : (
                                  <span className="text-slate-300 font-mono">—</span>
                                )}
                              ...
                              <td className="py-3 px-4 text-right">
                                {rec.totalPoints !== null && rec.totalPoints !== undefined ? (
                                  ...
                                  <span className="text-slate-400 text-xs italic font-normal">
                                    Incomplete ({rec.gamesCompletedCount}/3)
                                  </span>
                                )}
                              </td>
                              ...
                              <td className="py-3 px-4 text-right">
                                {!data?.config.isFinalized && (
                                  <button
                                    ...
                                    className="p-1.5 text-slate-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors inline-flex items-center gap-1 text-xs"
                                    title="Edit placements for this squad"
                                  >
                            ...
                            {/* Cutoff Divider Indicator */}
                            {isCutoffLine && (
                              <tr key={`cutoff-${rec.teamId}`} className="bg-purple-100/50">
                                <td colSpan={8} className="py-1 px-4 text-center">
                                  <div className="flex items-center justify-center gap-2 text-[11px] font-bold text-purple-900 tracking-wider">
                                    <span>&mdash;&mdash;&mdash; TOP 12 QUALIFICATION CUTOFF BOUNDARY &mdash;&mdash;&mdash;</span>
                                  </div>
                                </td>
                              </tr>
                            )}
