...
class EventService {
  ...
  async getDashboardOverview(): Promise<ApiResponse<DashboardOverviewData>> {
    ...
    return apiClient.get<DashboardOverviewData>('/overview');
  }
  ...
  async createTeam(input: CreateTeamInput): Promise<ApiResponse<Team>> {
    ...
    this.logActivity({
      ...
      description: `New squad registered with ID ${teamId}. Assigned to ${newTeam.assignedTable}.`,
